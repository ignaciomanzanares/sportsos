  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 16px", overflow: "auto" }}>
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
        ...
        {!existingUser && googleHabilitado && <div style={{marginTop:"16px",textAlign:"center"}}>
          ...
          <motion.button whileHover={{scale:1.02}} whileTap={{scale:0.97}}
            onClick={async()=>{
              ...
              // El error iba solo a la consola: se apretaba el boton y no
              // pasaba nada visible, ni redireccion ni aviso.
              if(error) setError("No pudimos conectar con Google: " + error.message);
            }}
